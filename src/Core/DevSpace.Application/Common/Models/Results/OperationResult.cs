...
public class OperationResult<TResult> : IOperationResult
{
    ...
    public static OperationResult<TResult> FailureResult(string propertyName, string message, TResult result)
    {
    ...
    public static OperationResult<TResult> FailureResult(string message, TResult result)
    {
        ...
        operationResult.ErrorMessages.Add(new("General Error", message));
